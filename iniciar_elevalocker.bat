...
:: Servidor real (bancada / producao) — nao usar simulador ESP32
if not defined ESP32_MODO_SIMULACAO set "ESP32_MODO_SIMULACAO=0"
if not defined APP_URL_BASE set "APP_URL_BASE=http://192.168.16.130:15000"
